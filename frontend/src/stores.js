...
import { GetProxyItems, GetLogs, GetMarasiConfig, GetFilters, GetExtensionCode, GetWaypoints} from './lib/wailsjs/go/main/App';
...
export async function populateWorkshop() {
    GetExtensionCode("workshop").then((code) => {
...
export async function populateCheckpoint() {
    GetExtensionCode("checkpoint").then((code) => {
...
export async function populateScope() {
    GetExtensionCode("compass").then((code) => {
